...
const Hero = () => {
    return (
        <div id="home" className="hero flex items-center flex-col gap-[35px]">
            <img className="image mt-[100px] h-[300px] w-[300px]" src={myProfile} alt="" />
            <h1 className="w-[70%]  text-center text-6xl font-semibold text-yellow-400 ">I'm Vivek Kumar Mishra </h1>
            <h2 class="w-[70%] text-center text-6xl font-semibold bg-clip-text text-transparent bg-gradient-to-r from-yellow-500 via-purple-500 to-pink-500">Full Stack Developer</h2>

            <p className="w-[50%] text-center leading-6 text-4xl">Welcome to my portfolio..</p>
