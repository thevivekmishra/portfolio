...
const Navbar = () => {
    ...
    return (
        <div className="navbar flex justify-between items-center w-full fixed top-0 bg-[#161513] z-[100]  ">
            <div className="w-[1400px] m-auto flex justify-around items-center ">
