...
const Certificate = () => {
    ...
    return (
        <div id="certificates" className="certificates flex flex-col items-center justify-center mt-8 mb-10">
            <div className="certificate-title relative text-center">
                <h1 className="pt-16 pb-10 text-5xl font-bold">Certificates</h1>
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 max-w-7xl mt-8">
                {/* Certificate 1 */}
                <div className="certificate-card bg-gradient-to-r from-gray-800 via-gray-700 to-gray-600 shadow-md rounded-lg overflow-hidden hover:shadow-lg transition-all ease-in-out">
                ...
                <div className="certificate-card bg-gradient-to-r from-gray-800 via-gray-700 to-gray-600 shadow-md rounded-lg overflow-hidden hover:shadow-lg transition-all ease-in-out">
                    ...
                    <div className="p-6 text-white">
                        ...
                        <button className="btn-download bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-4" onClick={() => handleDownload(ir4)}>Download Certificate</button>
                    </div>
                </div>
            </div>
        </div>
